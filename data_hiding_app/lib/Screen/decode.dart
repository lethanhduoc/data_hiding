...
class DecodeScreen extends StatefulWidget {
  const DecodeScreen({super.key, required this.fullName});
...
void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title:Text("Data Hiding", style: GoogleFonts.sarabun(color:Colors.white, fontSize: 25, fontWeight: FontWeight.bold)),
                    ...
                    _uploadData( contentController.text, image!.path);
            ...
            child: Column(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                     Text("Nhập username", style:GoogleFonts.sarabun(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 25)),
                    Padding(
  ...
  Future<void> _uploadData( String content, String imagepath) async {
